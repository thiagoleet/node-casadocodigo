...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/learning-node$1.0.0/src/app/views/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("<h1>Cadastro de livros</h1><form action=\"/livros\" method=\"post\"><div><label for=\"titulo\">Titulo:</label><input type=\"text\" id=\"titulo\" name=\"titulo\"" +
  ...
  out.w("<input type=\"submit\" value=\"Salvar\"></form>");
...
marko_template.meta = {
    id: "/learning-node$1.0.0/src/app/views/livros/form/form.marko",
    tags: [
